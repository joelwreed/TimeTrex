...
/*
 * $Revision: 2740 $
 * $Id: CurrencyFactory.class.php 2740 2009-08-19 20:21:50Z ipso $
...
class CurrencyFactory extends Factory {
	...
	function addLog( $log_action ) {
		return TTLog::addEntry( $this->getId(), $log_action,  TTi18n::getText('Currency').': '. $this->getISOCode() .' '.  TTi18n::getText('Rate').': '. $this->getConversionRate(), NULL, $this->getTable() );
	}

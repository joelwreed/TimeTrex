...
/*
 * $Revision: 2858 $
 * $Id: Wage.class.php 2858 2009-09-29 18:12:05Z ipso $
...
/*
	function getAnnualHourlyRate( $user_wage_id, $exclude_stats = FALSE, $exclude_vacation = FALSE ) {
		if ( is_object($this->getUserWageObject( $user_wage_id ) ) ) {
			return $this->getUserWageObject( $user_wage_id )->getAnnualHourlyRate( $exclude_stats, $exclude_vacation, $this->getPayPeriodObject()->getStartDate() );
		}

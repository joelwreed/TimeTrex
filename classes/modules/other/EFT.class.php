...
/*
 * $Revision: 2095 $
 * $Id: EFT.class.php 2095 2008-09-01 07:04:25Z ipso $
...
class EFT {
	...
	var $file_format_options = array( '1464','105', 'HSBC' );
...
class EFT_File_Format_1464 Extends EFT {
	...
	private function compileFooter() {
		...
		$line[] = $this->padRecord( count($this->compiled_data)+2, 9, 'N'); //add 2, 1 for the A record, and 1 for the Z record.
...
class EFT_File_Format_ACH Extends EFT {
	...
	http://chat.cashproweb.com/cpuniversity/portal/training/Technical_Resources/NACHA%20FORMAT_LNA%20and%20SFB.pdf

...
/*
 * $Revision: 2723 $
 * $Id: ExceptionPolicyControlFactory.class.php 2723 2009-08-13 22:05:43Z ipso $
...
class ExceptionPolicyControlFactory extends Factory {
	...
	function addLog( $log_action ) {
		return TTLog::addEntry( $this->getId(), $log_action, TTi18n::getText('Exception Policy'), NULL, $this->getTable() );
	}
}
?>

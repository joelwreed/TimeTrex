...
/*
 * $Revision: 2682 $
 * $Id: OverTimePolicyFactory.class.php 2682 2009-07-23 22:31:20Z ipso $
...
//										30 => TTi18n::gettext('Bi-Weekly'), //If we do this, we will need to recalculate two weeks ahead, instead of just one.
...
//										110 => TTi18n::gettext('Exceeds Daily Schedule Time'), //If they were scheduled 8hrs, and they worked 9hrs.
										...
										200 => TTi18n::gettext('Over Schedule / No Schedule')
									);
				break;
			case 'calculation_order':
				$retval = array(
										...
										180 => 10, //Holiday
										200 => 100, //Over Schedule / No Schedule
									);
				break;
			case 'columns':
				$retval = array(
										...
										'-1140-trigger_time' => TTi18n::gettext('Active After'),
	...
	function addLog( $log_action ) {
		return TTLog::addEntry( $this->getId(), $log_action,  TTi18n::getText('OverTime Policy'), NULL, $this->getTable() );
	}
}
?>

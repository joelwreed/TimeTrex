...
/*
 * $Revision: 3021 $
 * $Id: PremiumPolicyFactory.class.php 3021 2009-11-11 23:33:03Z ipso $
...
class PremiumPolicyFactory extends Factory {
	...
	*/
	...
	function isTimeRestricted() {
		...
		if ( $this->getEndTime() - $this->getStartTime() > (23.5*3600) ) {
			return FALSE;
		}
	...
	function addLog( $log_action ) {
		return TTLog::addEntry( $this->getId(), $log_action,  TTi18n::getText('Premium Policy'), NULL, $this->getTable() );
	}
}
?>

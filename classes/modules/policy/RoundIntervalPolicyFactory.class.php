...
/*
 * $Revision: 2698 $
 * $Id: RoundIntervalPolicyFactory.class.php 2698 2009-07-31 20:50:37Z ipso $
...
class RoundIntervalPolicyFactory extends Factory {
	...
	function addLog( $log_action ) {
		return TTLog::addEntry( $this->getId(), $log_action,  TTi18n::getText('Round Interval Policy'), NULL, $this->getTable() );
	}
}
?>

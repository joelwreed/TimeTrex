...
/*
 * $Revision: 3021 $
 * $Id: UserWageFactory.class.php 3021 2009-11-11 23:33:03Z ipso $
	...
	function Validate() {
		if ( $this->getDeleted() == FALSE ) {
				$this->Validator->isTrue(		'effective_date',
												...
												TTi18n::gettext('An employees first wage entry must be effective on or before the employees hire date'));
		}

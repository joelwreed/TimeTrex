...
/*
 * $Revision: 2095 $
 * $Id: PayrollDeduction_Base.class.php 2095 2008-09-01 07:04:25Z ipso $
...
class PayrollDeduction_Base {
	...
	// OSC: Set the user currency for calculations
	...
	// OSC: Get the user currency for calculations
	...
	// OSC: This function convert '$amount' from the user currency, to the country currency for calculations
	...
	// OSC: This function convert '$amount' from the country currency, to the user currency.

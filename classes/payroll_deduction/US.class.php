...
/*
 * $Revision: 2095 $
 * $Id: US.class.php 2095 2008-09-01 07:04:25Z ipso $
...
/*
			...
			$federal_rate = $this->getData()->getFederalRate( $modified_annual_taxable_income );

			$retval = bcmul( bcsub($modified_annual_taxable_income, $federal_constant), $federal_rate);
*/
	...
	function getEmployerSocialSecurity() {
		return $this->getEmployeeSocialSecurity();
	}
	...
	function getEmployeeMedicare() {
		...
		$pay_period_income = $this->getGrossPayPeriodIncome();
		$rate = bcdiv( $this->getMedicareRate(), 100 );
	...
	//
	// Earning Income Tax Credit (EIC, EITC)
	//
	function getEIC() {

...
/*
 * $Revision: 2644 $
 * $Id: EditPayPeriodSchedule.php 2644 2009-07-10 19:27:12Z ipso $
 * $Date: 2009-07-10 12:27:12 -0700 (Fri, 10 Jul 2009) $
 */
		...
		if ( isset($id) ) {
			...
			foreach ($ppslf as $pay_period_schedule) {
				...
				$pay_period_schedule_data = array(
													...
													'timesheet_verify_before_end_date' => (int)$pay_period_schedule->getTimeSheetVerifyBeforeEndDate(),
													'timesheet_verify_before_transaction_date' => (int)$pay_period_schedule->getTimeSheetVerifyBeforeTransactionDate(),

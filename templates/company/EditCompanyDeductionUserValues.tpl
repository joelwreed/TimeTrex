	...
	<tbody id="300-US-IN" style="display:none" >
		{if $page_type != 'user'}
			<tr onClick="showHelpEntry('user_value5')">
				...
				<td class="cellRightEditTable">
					<input type="text" size="25" name="data[user_value5]" value="{$data.user_value5}" disabled>
					{if $data.default_user_value5 != ''}(Default: {$data.default_user_value5}){/if}
				</td>
			</tr>
		{/if}

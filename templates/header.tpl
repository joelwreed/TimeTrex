...
<div id="container">
	<div id="rowHeader">
		<span class="imgClientLogo">
			<a href="{$BASE_URL}index.php"><img src="{if $current_company->getLogoFileName() != FALSE}{$BASE_URL}/send_file.php?object_type=company_logo{else}{$IMAGES_URL}timetrex_logo_wbg_small2.jpg{/if}" style="width:auto; height:42px; visibility: hidden;" id="header_logo" alt="TimeTrex"></a>
		</span>

...
<div id="rowContentInner">
		...
		<form method="get" action="{$smarty.server.SCRIPT_NAME}">
				...
				<tr class="tblDataWhiteNH">
					<td colspan="2">
						<br>
						<a href="http://www.timetrex.com"><img src="{$IMAGES_URL}timetrex_logo_wbg_small2.jpg" width="167" height="42" alt="TimeTrex"></a>
						<br>
						<br>
					</td>
				</tr>
				...
				<tr class="tblDataWarning">
					<td colspan="2">
						<br>
						{t escape="no"}<b>NOTICE:</b> There is a new version of <b>TimeTrex</b> available.{/t}
						<br>
						...
						<br>
						{t escape="no"}The latest version can be downloaded from:{/t} <a href="http://www.timetrex.com/?upgrade=1" target="_blank"><b>www.TimeTrex.com</b></a>
						<br>
						<br>
					</td>
				</tr>

		...
		<form method="get" action="{$smarty.server.SCRIPT_NAME}">
				...
				<tr>
					<td class="tblDataWhiteNH" colspan="7" align="right">
						...
						<br>
 						{*
						{t escape="no" 1='<a href="http://www.timetrex.com/help/help.php?product=admin&edition={php}echo getTTProductEdition(){/php}&version={$APPLICATION_VERSION}&language=en">' 2='</a>' 3=$APPLICATION_NAME}We recommend that you read our %1Administrator Guide%2 to help you get started with %3.{/t}<br>
						*}
						...
						<br>
						<br>
						{t escape="no"}You may now <a href="{$BASE_URL}/Login.php">login</a> with the user name/password that you created earlier.{/t}
					</td>
				</tr>
			</table>
		</form>

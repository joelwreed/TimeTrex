							...
							<tr>
								...
								<td class="cellRightEditTable">
									{if $install_obj->checkWritableConfigFile() == 0}
										<span class="">{t}OK{/t}
									{elseif $install_obj->checkWritableConfigFile() == 1}
							...
							<tr>
								...
								<td class="cellRightEditTable">
									{if $install_obj->checkWritableCacheDirectory() == 0}
										<span class="">{t}OK{/t}
									{elseif $install_obj->checkWritableCacheDirectory() == 1}
							...
							<tr>
								...
								<td class="cellRightEditTable">
									{if $install_obj->checkWritableStorageDirectory() == 0}
										<span class="">{t}OK{/t}
									{elseif $install_obj->checkWritableStorageDirectory() == 1}
							...
							<tr>
								...
								<td class="cellRightEditTable">
									{if $install_obj->checkWritableLogDirectory() == 0}
										<span class="">{t}OK{/t}
									{elseif $install_obj->checkWritableLogDirectory() == 1}
							...
							<tr>
								...
								<td class="cellRightEditTable">
									{if $install_obj->checkCleanCacheDirectory() == 0}
										<span class="">OK
									{elseif $install_obj->checkCleanCacheDirectory() == 1}

		    ...
		    <div id="contentBoxTwoEdit">
				...
				{else}
					<tr onClick="showHelpEntry('to')">
						<td class="{isvalid object="mf" label="to" value="cellLeftEditTable"}" style="width: 20%;">
							{t}To:{/t}
						</td>
				...
				<tr onClick="showHelpEntry('require_ack')">
					<td class="{isvalid object="mf" label="require_ack" value="cellLeftEditTable"}" style="width: 20%;">

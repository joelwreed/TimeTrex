...
*}
				...
				<tr onClick="showHelpEntry('rate')">
					...
					<td class="cellRightEditTable">
						<input type="text" size="10" name="pay_stub_amendment_data[rate]" id="rate" value="{$pay_stub_amendment_data.rate}" onKeyUp="calcAmount()">
				...
				<tr onClick="showHelpEntry('units')">
					...
					<td class="cellRightEditTable">
						<input type="text" size="10" name="pay_stub_amendment_data[units]" id="units" value="{$pay_stub_amendment_data.units}" onKeyUp="calcAmount()">
					</td>
				</tr>
				...
				<tr onClick="showHelpEntry('amount')">
					...
					<td class="cellRightEditTable">
						<input type="text" size="10" name="pay_stub_amendment_data[amount]" id="amount" value="{$pay_stub_amendment_data.amount}">
					</td>
				</tr>
				</tbody>

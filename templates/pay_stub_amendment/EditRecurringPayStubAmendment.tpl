		...
		<form method="post" action="{$smarty.server.SCRIPT_NAME}">
		    <div id="contentBoxTwoEdit">
				...
				<tr onClick="showHelpEntry('name')">
					<td class="{isvalid object="psaf" label="name" value="cellLeftEditTable"}">
						{t}Name:{/t}
					</td>
					<td class="cellRightEditTable">
				...
				<tr onClick="showHelpEntry('frequency')">
					<td class="{isvalid object="psaf" label="frequency" value="cellLeftEditTable"}">
						{t}Frequency:{/t}
					</td>
					<td class="cellRightEditTable">
				...
				<tr onClick="showHelpEntry('start_date')">
					<td class="{isvalid object="psaf" label="start_date" value="cellLeftEditTable"}">
						{t}Start Date:{/t}
					</td>
					<td class="cellRightEditTable">
				...
				<tr onClick="showHelpEntry('end_date')">
					<td class="{isvalid object="psaf" label="end_date" value="cellLeftEditTable"}">
						{t}End Date:{/t}
					</td>
					<td class="cellRightEditTable">
				...
				<tr>
					<td class="{isvalid object="psaf" label="user_ids" value="cellLeftEditTable"}" nowrap>

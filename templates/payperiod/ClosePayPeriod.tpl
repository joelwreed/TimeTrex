...
<div id="rowContentInner">
					...
					{foreach from=$pay_periods item=pay_period name="pay_periods"}
						...
						<tr class="{$row_class}">
							...
							<td colspan="1">
								<table width="100%" align="center" >
									<tr>
										<td width="20" style="background: {if $pay_period.high_severity_exceptions > 0}red{else}green{/if};">
											<br>
										</td>
										<td align="center">
											<b>
											...
											/ <font color="red">{$pay_period.high_severity_exceptions}</font>
											</b>
										</td>
									</tr>
								</table>
		...
		<form method="get" action="{$smarty.server.SCRIPT_NAME}">
					...
					<tr class="tblHeader">
						...
						<td colspan="2" align="center">
							<input type="submit" name="action:close" value="{t}Close{/t}" onClick="javascript: return confirmSubmit('{t}Once a Pay Period is closed it cannot be re-opened, and Pay Stubs cannot be modified.\\n\\nAre you sure you want to close this Pay Period now?{/t}')">
						</td>
					</tr>
			{/if}
				</table>

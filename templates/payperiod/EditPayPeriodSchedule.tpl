{include file="header.tpl" enable_calendar=true enable_ajax=TRUE body_onload="showType(); changeDailyStartTime(); filterUserCount();"}
...
<div id="rowContentInner">
		...
		<form method="post" action="{$smarty.server.SCRIPT_NAME}">
		    <div id="contentBoxTwoEdit">
				...
				<tr onClick="showHelpEntry('startweekday')">
					<td class="{isvalid object="ppsf" label="startweekday" value="cellLeftEditTable"}">
						{t}Overtime Week:{/t}
					</td>
					<td colspan="3" class="cellRightEditTable">
						<select name="pay_period_schedule_data[start_week_day_id]">
							{html_options options=$pay_period_schedule_data.startweekday_options selected=$pay_period_schedule_data.start_week_day_id}
						</select>
					</td>
				</tr>
				...
				<tr class="cellLeftEditTable" style="text-align:center">
					<td colspan="4">
						{t}TimeSheet Verification Window{/t}
					</td>
				</tr>
				...
				<tr onClick="showHelpEntry('timesheet_verify_before_end_date')">
					<td class="{isvalid object="ppsf" label="timesheet_verify_before_end_date" value="cellLeftEditTable"}">
						{t}Before Pay Period End Date:{/t}
					</td>
					<td colspan="3" class="cellRightEditTable">
				...
				<tr onClick="showHelpEntry('timesheet_verify_before_transaction_date')">
					<td class="{isvalid object="ppsf" label="timesheet_verify_before_transaction_date" value="cellLeftEditTable"}">
						{t}Before Pay Period Transaction Date:{/t}
					</td>
					<td colspan="3" class="cellRightEditTable">

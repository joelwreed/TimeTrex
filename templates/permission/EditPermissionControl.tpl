							...
							<tr class="tblHeader">
								<td colspan="6">
									{t}Permission Presets:{/t}
										...
										<input type="checkbox" name="data[preset_flags][job]" value="1"> {t}Job Tracking{/t}
										<input type="checkbox" name="data[preset_flags][invoice]" value="1"> {t}Invoicing{/t}
										<input type="checkbox" name="data[preset_flags][document]" value="1"> {t}Documents{/t}
										{/if}

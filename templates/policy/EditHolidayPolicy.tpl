{include file="header.tpl" body_onload="showType();"}
		    ...
		    <div id="contentBoxTwoEdit">
				...
				<tr onClick="showHelpEntry('minimum_worked_after_days')">
					...
					<td class="cellRightEditTable">
						...
						{t}days following the holiday{/t}.
					</td>
				</tr>
				</tbody>
				...
				<tr onClick="showHelpEntry('average_time_days')">
					<td class="{isvalid object="hpf" label="average_time_days" value="cellLeftEditTable"}">
						{t}Days to Average Time over:{/t}
					</td>
					<td class="cellRightEditTable">
						<input size="3" type="text" name="data[average_time_days]" value="{$data.average_time_days}">
						<b>{t}Worked Days Only:{/t}</b> <input type="checkbox" class="checkbox" name="data[average_time_worked_days]" value="1"{if $data.average_time_worked_days == TRUE}checked{/if}>
					</td>
				</tr>
				...
				<tr onClick="showHelpEntry('force_over_time_policy')">
					<td class="{isvalid object="hpf" label="force_over_time_policy" value="cellLeftEditTable"}">
						{t}Always Apply Over Time Policy:{/t}
					</td>
					<td class="cellRightEditTable">

		...
		<form method="post" name="wage" action="{$smarty.server.SCRIPT_NAME}">
		    <div id="contentBoxTwoEdit">
				...
				<tr onClick="showHelpEntry('start_time')">
					<td class="{isvalid object="rscf" label="start_time" value="cellLeftEditTable"}">
						{t}Start Time{/t}:
					</td>
					<td class="cellRightEditTable">
				...
				<tr onClick="showHelpEntry('end_time')">
					<td class="{isvalid object="rscf" label="end_time" value="cellLeftEditTable"}">
						{t}End Time{/t}:
					</td>
					<td class="cellRightEditTable">
				...
				<tr onClick="showHelpEntry('include_partial_punch')">
					<td class="{isvalid object="hpf" label="include_partial_punch" value="cellLeftEditTable"}">
				...
				<tr onClick="showHelpEntry('daily_trigger_time')">
					<td class="{isvalid object="otpf" label="daily_trigger_time" value="cellLeftEditTable"}">
						{t}Active After Daily (Regular) Hours{/t}:
					</td>
					<td class="cellRightEditTable">
						<input type="text" size="8" name="data[daily_trigger_time]" value="{gettimeunit value=$data.daily_trigger_time}"> {$current_user_prefs->getTimeUnitFormatExample()}
					</td>
				</tr>

				<tr onClick="showHelpEntry('weekly_trigger_time')">
					<td class="{isvalid object="otpf" label="weekly_trigger_time" value="cellLeftEditTable"}">
						{t}Active After Weekly (Regular) Hours{/t}:
					</td>
					<td class="cellRightEditTable">
						<input type="text" size="8" name="data[weekly_trigger_time]" value="{gettimeunit value=$data.weekly_trigger_time}"> {$current_user_prefs->getTimeUnitFormatExample()}
					</td>
				</tr>

				<tr onClick="showHelpEntry('effective_days')">
					<td class="{isvalid object="rscf" label="effective_days" value="cellLeftEditTable"}">
						{t}Effective Days{/t}:
					</td>
					<td class="cellRightEditTable">
						<table width="280">
				...
				<tr>
					<td class="{isvalid object="ppf" label="branch" value="cellLeftEditTable"}" nowrap>
						<b>{t}Branches{/t}:</b><a href="javascript:toggleRowObject('filter_branch_on');toggleRowObject('filter_branch_off');filterbranchCount();"><img style="vertical-align: middle" src="{$IMAGES_URL}/nav_top_sm.gif"></a>
					</td>
					<td colspan="3">
						<table class="editTable">
						<tr class="tblHeader">
				...
				<tr>
					<td class="{isvalid object="ppf" label="department" value="cellLeftEditTable"}" nowrap>
						<b>{t}Departments{/t}:</b><a href="javascript:toggleRowObject('filter_department_on');toggleRowObject('filter_department_off');filterdepartmentCount();"><img style="vertical-align: middle" src="{$IMAGES_URL}/nav_top_sm.gif"></a>
					</td>
					<td colspan="3">
						<table class="editTable">
						<tr class="tblHeader">
				...
				{if $current_company->getProductEdition() == 20}
					...
					<tr>
						<td class="{isvalid object="ppf" label="job_group" value="cellLeftEditTable"}" nowrap>
							<b>{t}Job Groups{/t}:</b><a href="javascript:toggleRowObject('filter_job_group_on');toggleRowObject('filter_job_group_off');filterjob_groupCount();"><img style="vertical-align: middle" src="{$IMAGES_URL}/nav_top_sm.gif"></a>
						</td>
						<td colspan="3">
							<table class="editTable">
							<tr class="tblHeader">
					...
					<tr>
						<td class="{isvalid object="ppf" label="job" value="cellLeftEditTable"}" nowrap>
							<b>{t}Jobs{/t}:</b><a href="javascript:toggleRowObject('filter_job_on');toggleRowObject('filter_job_off');filterjobCount();"><img style="vertical-align: middle" src="{$IMAGES_URL}/nav_top_sm.gif"></a>
						</td>
						<td colspan="3">
							<table class="editTable">
							<tr class="tblHeader">
					...
					<tr>
						<td class="{isvalid object="ppf" label="job_item_group" value="cellLeftEditTable"}" nowrap>
							<b>{t}Task Groups{/t}:</b><a href="javascript:toggleRowObject('filter_job_item_group_on');toggleRowObject('filter_job_item_group_off');filterjob_item_groupCount();"><img style="vertical-align: middle" src="{$IMAGES_URL}/nav_top_sm.gif"></a>
						</td>
						<td colspan="3">
							<table class="editTable">
							<tr class="tblHeader">
					...
					<tr>
						<td class="{isvalid object="ppf" label="job_item" value="cellLeftEditTable"}" nowrap>
							<b>{t}Tasks{/t}:</b><a href="javascript:toggleRowObject('filter_job_item_on');toggleRowObject('filter_job_item_off');filterjob_itemCount();"><img style="vertical-align: middle" src="{$IMAGES_URL}/nav_top_sm.gif"></a>
						</td>
						<td colspan="3">
							<table class="editTable">
							<tr class="tblHeader">
				...
				<tr onClick="showHelpEntry('maximum_no_break_time')">
					<td class="{isvalid object="otpf" label="maximum_no_break_time" value="cellLeftEditTable"}">
				...
				<tr onClick="showHelpEntry('mimimum_break_time')">
					<td class="{isvalid object="otpf" label="minimum_break_time" value="cellLeftEditTable"}">

		...
		<form method="post" name="report" action="{$smarty.server.SCRIPT_NAME}">
		    ...
		    <div id="contentBoxTwoEdit">
				...
				<tr>
					...
					<td class="cellRightEditTable">
						<select id="columns" name="setup_data[total_payment_psea_ids][]" size="{select_size array=$filter_data.income_pay_stub_entry_account_options}" multiple>
							{html_options options=$filter_data.income_pay_stub_entry_account_options selected=$setup_data.total_payment_psea_ids}
						</select>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cellRightEditTable">
						<select id="columns" name="setup_data[exempt_payment_psea_ids][]" size="{select_size array=$filter_data.deduction_pay_stub_entry_account_options}" multiple>
							{html_options options=$filter_data.deduction_pay_stub_entry_account_options selected=$setup_data.exempt_payment_psea_ids}
						</select>
					</td>
				</tr>
				<tr>

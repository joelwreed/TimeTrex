		...
		<form method="post" name="report" action="{$smarty.server.SCRIPT_NAME}">
		    ...
		    <div id="contentBoxTwoEdit">
				...
				{if !isset($setup_data.2_psea_ids)
						...
						OR !isset($setup_data.9_psea_ids)}
				...
				<tr>
					...
					<td class="cellRightEditTable">
						<select id="columns" name="setup_data[2_psea_ids][]" size="{select_size array=$filter_data.income_pay_stub_entry_account_options}" multiple>
							{html_options options=$filter_data.income_pay_stub_entry_account_options selected=$setup_data.2_psea_ids}
						</select>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cellRightEditTable">
						<select id="columns" name="setup_data[3_psea_ids][]" size="{select_size array=$filter_data.deduction_pay_stub_entry_account_options}" multiple>
							{html_options options=$filter_data.deduction_pay_stub_entry_account_options selected=$setup_data.3_psea_ids}
						</select>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cellRightEditTable">
						<select id="columns" name="setup_data[5a_psea_ids][]" size="{select_size array=$filter_data.earning_pay_stub_entry_account_options}" multiple>
							{html_options options=$filter_data.earning_pay_stub_entry_account_options selected=$setup_data.5a_psea_ids}
						</select>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cellRightEditTable">
						<select id="columns" name="setup_data[5b_psea_ids][]" size="{select_size array=$filter_data.earning_pay_stub_entry_account_options}" multiple>
							{html_options options=$filter_data.earning_pay_stub_entry_account_options selected=$setup_data.5b_psea_ids}
						</select>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cellRightEditTable">
						<select id="columns" name="setup_data[5c_psea_ids][]" size="{select_size array=$filter_data.earning_pay_stub_entry_account_options}" multiple>
							{html_options options=$filter_data.earning_pay_stub_entry_account_options selected=$setup_data.5c_psea_ids}
						</select>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2" class="{isvalid object="ugdf" label="tax" value="cellLeftEditTable"}">
						{t}Sick Pay (Line 7b):{/t}
					</td>
					<td class="cellRightEditTable">
						<select id="columns" name="setup_data[7b_psea_ids][]" size="{select_size array=$filter_data.earning_pay_stub_entry_account_options}" multiple>
							{html_options options=$filter_data.earning_pay_stub_entry_account_options selected=$setup_data.7b_psea_ids}
						</select>
					</td>
				</tr>
				...
				<tr>
					<td colspan="2" class="{isvalid object="ugdf" label="tax" value="cellLeftEditTable"}">
						{t}Earned Income Credit (EIC) (Line 9):{/t}
					</td>
					<td class="cellRightEditTable">

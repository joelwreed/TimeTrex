...
function showType() {
	...
	if ( type_id == 100 || type_id == 110 || type_id == 120 || type_id == 200 ) {
...
{*
				<tr onClick="showHelpEntry('user_name')">
					<td class="{isvalid object="sf" label="user_name" value="cellLeftEditTable"}">
						{t}User Name:{/t}
					</td>
					<td class="cellRightEditTable">
						<input type="text" name="data[user_name]" value="{$data.user_name}" size="25">
					</td>
				</tr>
*}
				...
				<tr onClick="showHelpEntry('poll_frequency')">
					...
					<td class="cellRightEditTable">
						<select name="data[poll_frequency]">
				...
				<tr>
					<td class="{isvalid object="sf" label="group" value="cellLeftEditTable"}" nowrap>
						<b>{t}Employee Groups{/t}:</b><a href="javascript:toggleRowObject('filter_group_on');toggleRowObject('filter_group_off');filtergroupCount();"><img style="vertical-align: middle" src="{$IMAGES_URL}/nav_top_sm.gif"></a>
					</td>
					<td colspan="3">
						<table class="editTable">
						<tr class="tblHeader">
				...
				<tr>
					<td class="{isvalid object="sf" label="include_user" value="cellLeftEditTable"}" nowrap>
						<b>{t}Include Employees{/t}:</b><a href="javascript:toggleRowObject('filter_include_user_on');toggleRowObject('filter_include_user_off');filterinclude_userCount();"><img style="vertical-align: middle" src="{$IMAGES_URL}/nav_top_sm.gif"></a>
					</td>
					<td colspan="3">
						<table class="editTable">
						<tr class="tblHeader">
				...
				<tr>
					<td class="{isvalid object="sf" label="exclude_user" value="cellLeftEditTable"}" nowrap>
						<b>{t}Exclude Employees{/t}:</b><a href="javascript:toggleRowObject('filter_exclude_user_on');toggleRowObject('filter_exclude_user_off');filterexclude_userCount();"><img style="vertical-align: middle" src="{$IMAGES_URL}/nav_top_sm.gif"></a>
					</td>
					<td colspan="3">
						<table class="editTable">
						<tr class="tblHeader">

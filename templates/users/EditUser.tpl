						...
						<table class="editTable">
							...
							<tr onClick="showHelpEntry('permission_control')">
								...
								<td class="cellRightEditTable">
									...
									*}
									{if $user_data.id != $current_user->getId() AND ( $permission->Check('permission','edit') OR $permission->Check('permission','edit_own') OR $permission->Check('user','edit_permission_group') ) }
							...
							<tr onClick="showHelpEntry('employee_number')">
								...
								<td class="cellRightEditTable">
									{if $permission->Check('user','edit') OR ($permission->Check('user','edit_child') AND $user_data.is_child === TRUE) OR ($permission->Check('user','edit_own') AND $user_data.is_owner === TRUE)}
							...
							<tr onClick="showHelpEntry('phone_password')">
								<td class="{isvalid object="uf" label="phone_password" value="cellLeftEditTable"}">
									{t}Phone Password (confirm):{/t}
								</td>
								<td class="cellRightEditTable">
									<input type="text" size="15" name="user_data[phone_password2]" value="{$user_data.phone_password2}">
								</td>
							</tr>
{*
							<tr onClick="showHelpEntry('ibutton_id')">
								<td class="{isvalid object="uf" label="ibutton_id" value="cellLeftEditTable"}">
									{t}iButton ID:{/t}
								</td>
								<td class="cellRightEditTable">
									<input type="text" name="user_data[ibutton_id]" value="{$user_data.ibutton_id}">
								</td>
							</tr>
*}
							...
							{/if}
{if $permission->Check('user','edit_advanced') AND ( $permission->Check('user','edit') OR ($permission->Check('user','edit_child') AND $user_data.is_child === TRUE) OR ($permission->Check('user','edit_own') AND $user_data.is_owner === TRUE) )}
						</table>
					</td>
					<td valign="top">
						<table class="editTable">

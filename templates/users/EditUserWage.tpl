		...
		<form method="post" name="wage" action="{$smarty.server.SCRIPT_NAME}">
		    <div id="contentBoxTwoEdit">
				...
				<tr onClick="showHelpEntry('wage')">
					...
					<td class="cellRightEditTable">
						{$wage_data.currency_symbol}<input id="wage_val" size="9" type="text" name="wage_data[wage]" value="{$wage_data.wage}" onChange="getHourlyRate()"> {$wage_data.iso_code}
					</td>
				</tr>
				...
				<tr onClick="showHelpEntry('hourly_rate')">
					...
					<td class="cellRightEditTable">
						<input type="text" id="hourly_rate" size="6" name="wage_data[hourly_rate]" value="{$wage_data.hourly_rate|default:0.00}">
					</td>
				</tr>

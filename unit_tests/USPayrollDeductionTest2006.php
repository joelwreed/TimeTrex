...
class USPayrollDeductionTest2006 extends PHPUnit_Framework_TestCase {
	...
	function testMA_2006a_BiWeekly_Single_LowIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '1000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '101.54' ); //101.54
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '41.08' ); //41.10
	}
	...
	function testMA_2006a_BiWeekly_Head_LowIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '1000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '56.54' ); //56.54
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '37.75' ); //36.82
	}
	...
	function testMA_2006a_BiWeekly_Blind_LowIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '1000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '56.54' ); //56.54
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '37.54' ); //36.61
	}
	...
	function testMA_2006a_SemiMonthly_Single_HighIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '4000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '601.08' ); //601.08
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '180.20' ); //180.65
	}
	...
	function testMA_2006a_SemiMonthly_Blind_HighIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '4000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '601.08' ); //601.08
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '175.34' ); //175.80
	}
	...
	function testAZ_2006a_BiWeekly_Single_LowIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '13.90' ); //13.90
	}
	...
	function testAL_2006a_BiWeekly_Single_LowIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '35.13' ); //35.12
	}
	...
	function testAL_2006a_BiWeekly_Single_MediumIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '73.80' );
	}
	...
	function testAL_2006a_BiWeekly_Married_LowIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '1000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '120.58' ); //120.58
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '26.86' ); //26.86
	}
	...
	function testAL_2006a_BiWeekly_Married_MediumIncome() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '2083.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '248.70' );
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '55.88' );
	}
	...
	function testAL_2006a_SemiMonthly_Married_HighIncome_8Allowances() {
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '4000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '823.73' ); //823.73
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '135.90' ); //135.90
	}

	//
	// LA
	//
	function testLA_2006a_BiWeekly_Single_LowIncome() {
		Debug::text('US - BiWeekly - Beginning of 2006 01-Jan-06: ', __FILE__, __LINE__, __METHOD__,10);
		...
		$pd_obj->setUserValue1( 0 ); //Allowance
		$pd_obj->setUserValue2( 0 ); //Dependant Allowance
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '1000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '101.54' ); //101.54
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '28.53' ); //28.53
	}

	function testLA_2006a_BiWeekly_Single_LowIncomeB() {
		Debug::text('US - BiWeekly - Beginning of 2006 01-Jan-06: ', __FILE__, __LINE__, __METHOD__,10);
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '1000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '101.54' ); //101.54
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '24.89' ); //24.89
	}

	function testLA_2006a_BiWeekly_Single_LowIncomeC() {
		Debug::text('US - BiWeekly - Beginning of 2006 01-Jan-06: ', __FILE__, __LINE__, __METHOD__,10);
		...
		$pd_obj->setUserValue1( 2 ); //Allowance
		$pd_obj->setUserValue2( 0 ); //Dependant Allowance
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '1000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '101.54' ); //101.54
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '14.25' ); //14.25
	}

	function testLA_2006a_SemiMonthly_HighIncome_8Allowances() {
		Debug::text('US - SemiMonthly - Beginning of 2006 01-Jan-06: ', __FILE__, __LINE__, __METHOD__,10);
		...
		$pd_obj->setUserValue1( 2 ); //Allowance
		$pd_obj->setUserValue2( 2 ); //Dependant allowance
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '4000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '823.73' ); //823.73
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '140.19' ); //140.19
	}
	...
	// UT
	//
	function testUT_2006a_BiWeekly_Single_LowIncome() {
		Debug::text('US - BiWeekly - Beginning of 2006 01-Jan-06: ', __FILE__, __LINE__, __METHOD__,10);
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '1000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '101.54' ); //101.54
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '55.08' ); //55.10
	}

	function testUT_2006a_BiWeekly_Married_LowIncome() {
		Debug::text('US - BiWeekly - Beginning of 2006 01-Jan-06: ', __FILE__, __LINE__, __METHOD__,10);
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '1000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '101.54' ); //101.54
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '46.42' ); //46.46
	}

	function testUT_2006a_SemiMonthly_Married_HighIncome_8Allowances() {
		Debug::text('US - SemiMonthly - Beginning of 2006 01-Jan-06: ', __FILE__, __LINE__, __METHOD__,10);
		...
		$this->assertEquals( $this->mf( $pd_obj->getGrossPayPeriodIncome() ), '4000.00' );
		$this->assertEquals( $this->mf( $pd_obj->getFederalPayPeriodDeductions() ), '823.73' ); //823.73
		$this->assertEquals( $this->mf( $pd_obj->getStatePayPeriodDeductions() ), '205.74' ); //205.79
	}
